  ...
  return (
    <>
      <div className="max-w-3xl mx-auto p-4">
        <h1 className="text-2xl font-bold mb-4">CARVEEPS PRIVACY POLICY</h1>
        <p className="mb-2">
          <strong>Effective Date:</strong> September 01, 2024
        </p>
        <p className="mb-4">
          Carveeps, Inc, a California corporation (“Carveeps”) respects the
          privacy of its customers, business partners, employees, job
          applicants, and App visitors (“You” and “your”). Protecting your
          ...
          linked, directly or indirectly, to you (“Personal Information”).
        </p>
        <p className="mb-4">
          This Privacy Policy (the “Policy”) describes how we treat data and
          your Personal Information that Carveeps collects and receives through
          this mobile application (the “App”), and other aspects of Carveeps’s
        ...
        <p className="mb-4">
          ...
          our services (see Section 2), as well as how we use it (see Section 3)
          and with whom we may have shared it (see Section 4).
        </p>
        <p className="mb-4">
          ...
          <tbody>
            <tr>
              ...
              <td className="border border-gray-300 p-2">
                ...
                identifier, Internet Protocol (“IP”) address, email address,
                Social Security number, or other similar identifiers. Note:
            ...
            <tr>
              ...
              <td className="border border-gray-300 p-2">
                Referenced in the California Customer Records statute (Cal. Civ.
                Code § 1798.80(e)). A name, signature, address, telephone
                number, passport number, driver’s license or state
                identification card number, insurance policy number, employment
                history. Notes: Some Personal Information included in this
                category may overlap with other categories. Personal Information
                does not include publicly available information from government
                records.
              </td>
              <td className="border border-gray-300 p-2">Yes</td>
            </tr>
            ...
            <tr>
              <td className="border border-gray-300 p-2">Sensory data</td>
              <td className="border border-gray-300 p-2">
      ...
      <div className="max-w-3xl mx-auto p-4">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td className="border border-gray-300 p-2">
                ...
                consumer’s preferences, characteristics, behavior, attitudes,
            ...
            <tr>
              ...
              <td className="border border-gray-300 p-2">
                Any personal information that reveals financial account, debit
                card, or credit card number in combination with any required
                security or access code, precise geolocation, etc.
              </td>
              <td className="border border-gray-300 p-2">Yes</td>
            </tr>
          </tbody>
        ...
        <p className="mb-4">
          We collect Personal Information, including without limitation:
        </p>
        <ul className="list-disc list-inside mb-4">
          <li>
            Identifiers, Personal Information referenced in the California
            Customer Records statute, Commercial information, Sensitive Personal
            Information and Sensory data (i.e., voicemail) directly from you
          ...
          <li>
            ...
            (i.e., voicemail), information we receive from you when you contact
            our main office for any inquiries.
          </li>
          <li>
            Identifiers and Personal Information referenced in the California
            Customer Records statute, information that you provide by filling in
            forms on our App. We may also ask you for information when you enter
            a contest, fundraiser, or promotion sponsored by us, and when you
            report a problem with our App.
          </li>
        </ul>
      </div>
      <div className="max-w-3xl mx-auto p-4">
        <h2 className="text-xl font-semibold mb-4">
          Identifiers and Personal Information Collection
        </h2>
        <p className="mb-4">
          Identifiers and Personal Information referenced in the California
          Customer Records statute that you provide in responses to surveys that
        ...
        <p className="mb-4">
          ...
          companies acting on our behalf may include, but is not limited to, log
          and usage data, IP addresses, cookies, pixel tags, web beacons, device
          data, location data, and other tracking technologies.
        </p>
        <p className="mb-4">
        ...
        <h3 className="text-lg font-semibold mb-2">Log and Usage Data</h3>
        <p className="mb-4">
          ...
          your activity in the App (such as the date/time stamps associated with
        ...
        <p className="mb-4">
          ...
          cookies. However, if you do so, the services may not work properly.
          These cookies and other related technology allow third-party companies
          to help us improve your experience on the App, understand how the App
          is being used, and measure the number of visitors to the App.
        </p>
        <p className="mb-4">
          Examples of such information we automatically collect include IP
          Address, a unique user ID, device and browser types and identifiers,
          referring and exit page addresses, software and system type, and
          information about your usage of the App. Examples of how Carveeps uses
          automatically collected information include to:
        </p>
        <ul className="list-disc list-inside mb-4">
          <li>
            (a) Remember your information so that you will not have to re-enter
            it during your visit or the next time you access the App;
          </li>
          <li>
            (b) Provide customized advertisements, content, and information;
          </li>
          <li>(c) Monitor the effectiveness of marketing campaigns;</li>
          <li>
            (d) Monitor and store aggregate site usage metrics such as total
            number of visitors and pages accessed;
          </li>
          <li>
            (e) Track your entries, submissions, and status in any promotions or
            other activities.
          </li>
        </ul>
        <p className="mb-4">
          ...
          certain cookies. For more information about removing cookies for your
          specific web browser, visit{" "}
          <a
      ...
      <div className="max-w-3xl mx-auto p-4">
        ...
        <h3 className="text-lg font-semibold mb-2">Pixel Tags/Web Beacons</h3>
        <p className="mb-4">
          A pixel tag (also known as a web beacon) is a piece of code embedded
          on the App that collects information about users’ engagement on that
          web page. The use of a pixel allows us to record, for example, that a
        ...
        <p className="mb-4">
          We, or a third party acting on our behalf, may collect device data
          such as information about your computer, phone, tablet, or other
          device you use to access the App. Depending on the device used, this
          device data may include information such as your IP address (or proxy
          server), device application identification numbers, location, browser
        ...
        <p className="mb-4">
          ...
          about you from other sources, such as public databases, analytics
          providers, data providers, social media platforms, service providers,
          and other third parties. If you interact with us on a social media
          platform using your social media account (e.g., Facebook, Instagram,
          X, or LinkedIn), we receive Personal Information about you such as
          your name, email address, and gender. Any Personal Information that we
        ...
        <ul className="list-disc list-inside mb-4">
          <li>
            To enable user-to-user communications. We may use your Personal
            Information, including without limitation, name, email address,
            telephone number, or mailing address, to enable user-to-user
            communications with each user’s consent.
          </li>
          <li>
            To respond to user inquiries/offer support to users. We may use your
            Personal Information, including without limitation, name, email
            address, telephone number, voicemail, or mailing address, to respond
            to your inquiries and solve any potential issues you might have with
            the use of our services.
          </li>
          <li>
            To create, manage, maintain, customize, and secure your account with
            us. We may use your Personal Information, including without
            limitation, name, email address, telephone number, mailing address,
            or commercial information for the purposes of creating, managing,
            customizing, and securing your account.
          </li>
          <li>
            To resolve bugs, troubleshoot problems, security incidents, and
            improve App operation. We may use your Personal Information,
            including without limitation, Internet or other electronic network
            activity and geolocation data, as part of our efforts to keep the
            App safe and secure (including to protect against malicious,
      ...
      <div className="max-w-3xl mx-auto p-4">
        ...
        <ul className="list-disc list-inside mb-4">
          <li>
            To improve, upgrade, or enhance the App and services. We may use
            your Personal Information, including without limitation, your IP
            address and geolocation data, to improve our App and its
            functionality.
          </li>
          <li>
            To send administrative information to you. We may use your Personal
            Information, including without limitation, your email address and
            name, to send you services, updates, new feature information, and/or
            information about changes to our terms, conditions, and policies.
          </li>
          <li>
            To send you marketing and promotional communications. We may use
            your Personal Information, including without limitation, your email
            address, name, commercial information, and inferences, to deliver
            targeted advertising, coupons, newsletters, and other information
            regarding promotions, the App, and properties we manage to you.
          </li>
          <li>
            To compile anonymous statistical data and analysis for use
            internally or with third parties. We may use your Personal
            Information, including without limitation, your IP address and
            geolocation data, to monitor and analyze usage and trends to improve
            your experience with the App.
          </li>
          <li>
            To request feedback. We may use your Personal Information, including
            without limitation your name, email address, and commercial
            information, to request feedback and to contact you about your use
            of the App.
          </li>
          <li>
            To operate the App and provide our services in accordance with our
            agreements you may have with us.
          </li>
          <li>
            To carry out other purposes that are disclosed to you and/or to
            which you consent.
          </li>
          <li>
            To pursue our legitimate interests where your rights and freedoms do
            not outweigh these interests.
          </li>
          <li>
            ...
            hold in order to determine how to respond.
          </li>
        </ul>
        ...
        <p className="mb-4">
          No “Selling” or “Sharing” of Personal Information: Carveeps does not
          sell your Personal Information or share your Personal Information for
          the purpose of behavioral advertising, and we do not allow any
          Personal Information to be used by third parties for their own
          marketing purposes. We do not exchange your Personal Information with
          others for monetary or other valuable consideration. We may process or
          share your Personal Information that we hold based on the following
          legal basis:
        </p>
        <ul className="list-disc list-inside mb-4">
          <li>
            <strong>Consent:</strong> We may process your data if you have given
            us specific consent or authorization to use your Personal
      ...
      <div className="max-w-3xl mx-auto p-4">
        ...
        <p className="mb-4">
          ...
          App, which will enable them to collect data on our behalf about how
          you interact with the App over time. This information may be used to
        ...
        <h3 className="text-lg font-semibold mb-2">Third-Party Advertisers</h3>
        <p className="mb-4">
          We may use third-party advertising companies to serve ads when you
          visit or use the App. These companies may use information about your
          visits to the App and other apps that are contained in web cookies and
          other tracking technologies to provide advertisements about goods and
          services of interest to you.
        </p>

        <h3 className="text-lg font-semibold mb-2">Business Partners</h3>
        <p className="mb-4">
          We may share your Personal Information with our business partners to
          offer you certain products, services, or promotions.
        </p>

        <h3 className="text-lg font-semibold mb-2">Legal Obligations</h3>
        <p className="mb-4">
          ...
          as in response to a court order or a subpoena (including in response
          to public authorities to meet national security or law enforcement
          requirements).
        </p>

        <h3 className="text-lg font-semibold mb-2">Vital Interests</h3>
        <p className="mb-4">
          ...
          potential threats to the safety of any person, illegal activities, or
        ...
        <p className="mb-4">
          ...
          third-party website and service provider before providing any personal
          information to them. We are not responsible for the privacy practices
          of third parties. If you choose to visit or use any third-party apps
          or websites, including those offered by our third-party service
          providers or other partners, please be aware that this Policy will not
          apply to information that you disclose to third parties.
        </p>
      </div>
      <div className="max-w-3xl mx-auto p-4">
        <h2 className="text-xl font-semibold mb-4">
        ...
        <p className="mb-4">
          ...
          website or web application disable its tracking of a user’s browsing
          data. Various web browsers (including Internet Explorer, Google
          Chrome, Firefox, and Safari) offer a “do not track” option, which
          sends a signal to the website or app visited by the user about his or
          her browser DNT preference setting.
        </p>
        <p className="mb-4">
          We do not directly respond to “Do Not Track” signals and no common
          industry standard for DNT has been adopted. We do not permit third
          parties other than our analytics and other service providers to track
          the users’ activity on the App. We do not track your online activity
          on other online services over time.
        </p>

        <h2 className="text-xl font-semibold mb-4">
          7. Notice at Collection For Job Applicants, Contractors, Or Similar
          Individuals
        </h2>
        <p className="mb-4">
        ...
        <table className="w-full border-collapse mb-4">
          <thead>
            <tr className="bg-gray-100">
              <th className="border p-2">Category of Information</th>
              <th className="border p-2">Why We Collect It</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td className="border p-2">Identifiers</td>
            ...
            <tr>
              ...
              <td className="border p-2">
                ...
                <br />• Comply with applicable state and federal Equal
            ...
            <tr>
              ...
              <td className="border p-2">
                This category includes, without limitation, Internet or other
                electronic network activity information such as browsing
                history, search history, and information regarding your
                interaction with internet web sites and applications.
                <br />• Facilitate the efficient and secure use of the company’s
                information systems, ensure compliance with company policies and
                procedures, and investigate complaints and any suspected
                violations of company policy.
              </td>
            </tr>
            <tr>
              <td className="border p-2">Geolocation</td>
              <td className="border p-2">
                This category includes physical location or movements such as
                GPS location data.
                <br />• Improve safety of employees, customers, and the public
                with regard to use of Carveeps property and equipment. Prevent
            ...
            <tr>
              ...
              <td className="border p-2">
                This category includes work history, prior employer, references,
                qualifications, skills and experience, human resources data,
                emergency contact information, and data necessary for benefits
            ...
            <tr>
              <td className="border p-2">Education Information</td>
              <td className="border p-2">
                This category includes education history.
                <br />• Process, evaluate, and communicate with an individual
                about his or her application and assess his or her eligibility
                and fit for the role for which the individual applied.
              </td>
            </tr>
            <tr>
              <td className="border p-2">Inferences</td>
              <td className="border p-2">
                Inferences drawn from any of the Personal Information listed
                above.
                <br />• Assess qualifications for certain positions to create a
                profile reflecting his or her preferences, characteristics,
                behavior, attitudes, intelligence, abilities, and aptitudes.
              </td>
            </tr>
            <tr>
              <td className="border p-2">Sensitive Personal Information</td>
              <td className="border p-2">
                This category includes any private information that divulges
                personal identification numbers, including social security,
                driver's license, passport, or state ID card numbers.
                <br />• Collect and process employment applications, including
                confirming eligibility for employment, background and related
                checks, and onboarding.
              </td>
        ...
        <p className="mb-4">
          ...
          measures vary based on the nature of the information collected and the
          associated risks.
        </p>
      </div>
      <div className="max-w-3xl mx-auto p-4">
        ...
        <p className="mb-4">
          On the sensitivity of the Personal Information we collect, process,
          and store, and the current state of technology. We, or a third party
          acting on our behalf, will store the data necessary for encryption,
          especially the public and private keys (the private keys are stored
          encrypted; it is not possible to decrypt any private key). However, as
          technology continues to develop over time, there is no storage or
          transmission of data over the Internet that is guaranteed to be
          completely secure. We therefore cannot guarantee providing absolute
          security. Although we will do our best to protect your Personal
          Information, transmission of Personal Information to and from the App
        ...
        <p className="mb-4">
          ...
          purposes set out in this Policy. We will retain and use your Personal
        ...
        <p className="mb-4">
          ...
          Personal Information remains protected in accordance with this Policy
          and have implemented appropriate safeguards.
        </p>
        ...
        <p className="mb-4">
          ...
          and we will generally provide you with these rights and choices
          subject to some exceptions permitted by law. For example, if providing
          this access may disclose information about another person, or may
          disclose commercially sensitive information, we may need to refuse to
          grant you access. Details about how to contact us are at the end of
          this document.
        </p>
        <p className="mb-4">
          ...
          Carveeps will not charge a fee to consumers who exercise their rights
          under the California Consumer Privacy Act (CCPA) or California Privacy
          Rights Act (CPRA), unless Carveeps, at its sole discretion, determines
          that the consumer’s requests are “manifestly unfounded or excessive,”
          particularly due to their repetitive nature.
        </p>
        <p className="mb-4">
        ...
        <ul className="list-disc pl-5 mb-4">
          <li>
            <strong>Right to Access/Know:</strong> You may request any or all of
            the following information relating to your Personal Information we
            have collected and disclosed in the last 12 months, upon
            ...
            <ul className="list-disc pl-5">
              ...
              <li>
                The categories of Personal Information we have sold about you
                (if any), and the categories of third parties to whom the
          ...
          <li>
            ...
            request deletion of Personal Information that Carveeps has collected
            about you.
          </li>
          <li>
          ...
          <li>
            ...
            for the valid exercise of privacy rights conferred by the CCPA/CPRA.
          </li>
          <li>
            <strong>Right to Limit Use:</strong> You have the right to request
            that you limit a California consumer’s use and disclosure of your
            sensitive Personal Information.
          </li>
          <li>
            <strong>
            ...
            <ul className="list-disc pl-5">
              <li>
                ...
                compelling legal grounds for the processing; or
              </li>
              <li>
      ...
      <div className="max-w-3xl mx-auto p-4">
        ...
        <div className="mb-4">
          ...
          <p>Administrator</p>
          <p>Carveeps, Inc.</p>
          <p>5700 Cushing Parkway</p>
          <p>Fremont, CA 94538</p>
        </div>
        <div className="mb-4">
          <strong>Email Address:</strong>
          <p>Admin@carveeps.com</p>
        </div>
        ...
        <ul className="list-disc pl-5 mb-4">
          <li>
            ...
            whether you are the person about whom we collected Personal
            Information or an authorized representative. We reserve the right to
            confirm your California residency. Government identification may be
            required.
          </li>
          <li>
            If you wish to designate an authorized agent to make a request on
            your behalf, we will need to verify both your and your agent’s
            identities, which may require submission of government
            identification. Your agent must also provide other proof of
            authority acceptable to us in our sole discretion.
          </li>
          <li>
        ...
        <p className="mb-4">
          ...
          request and confirm the Personal Information relates to you. In
        ...
        <h2 className="text-xl font-semibold mb-4">12. Non-Discrimination</h2>
        <p className="mb-4">
          We will not discriminate against you for exercising any of your
          CCPA/CPRA rights. You have the right not to receive discriminatory
          treatment by Carveeps for the exercise of privacy rights conferred by
          the CCPA/CPRA, including an employee’s, applicant’s, or independent
          contractor’s right not to be retaliated against for the exercise of
          their CCPA/CPRA rights. Unless permitted by the CCPA/CPRA, we will
          not:
        </p>
        <ul className="list-disc pl-5 mb-4">
        ...
        <p className="mb-4">
          ...
          your data or close your account, we won’t be able to offer you
          services that require us to use your data.
        </p>

        <h2 className="text-xl font-semibold mb-4">13. Minors</h2>
        <p className="mb-4">
          ...
          children’s online activities and interests. Neither the App nor our
          services are directed to children under 13 (or other age as defined by
          local law). We do not target our services or the App to children. We
          also do not knowingly collect Personal Information from children. If
          we learn that we have collected any Personal Information from a child
          in violation of applicable law, we will immediately take steps to
          delete such information. If you learn that your child has provided us
        ...
        <p className="mb-4">
          We reserve the right to change this Policy at any time. If we make any
          material changes to this Policy, we will update the “Effective Date”
          at the top of this page and update our notices on the App. You are
          responsible for ensuring we have an up-to-date active and deliverable
          email address for you, and for periodically visiting our App and this
