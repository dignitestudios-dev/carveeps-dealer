...
const SettingsNotifications = () => {
  ...
  const getSettings = () => {
    ...
    if (token) {
      ...
      setDataLoading(true);
      axios
        .get(`${baseUrl}/dealership/settings`, { headers })
        .then((response) => {
  ...
  useEffect(() => {
    if (data) {
      setSettings({
        ...
        subscriptionCancellation: data.subscriptionCancellation,
  ...
  const updateSettings = (newSettings) => {
    ...
    if (token) {
      ...
      setDataLoading(true);
      axios
        .put(`${baseUrl}/dealership/settings`, newSettings, { headers })
        .then((response) => {
          setUpdate((prev) => !prev);
          setDataLoading(false);
        })
          ...
          <>
            <div className="w-full h-auto flex justify-between items-start">
              ...
              <div>
                <label className="inline-flex items-center cursor-pointer">
                  <input
                    checked={settings.subscriptionCreated}
                    type="checkbox"
                    disabled={dataLoading}
                    onChange={(e) =>
                      handleCheckboxChange(e, "subscriptionCreated")
                    }
            ...
            <div className="w-full h-auto flex justify-between items-start">
              ...
              <div>
                <label className="inline-flex items-center cursor-pointer">
                  <input
                    checked={settings.subscriptionPurchased}
                    type="checkbox"
                    disabled={dataLoading}
                    onChange={(e) =>
                      handleCheckboxChange(e, "subscriptionPurchased")
                    }
                    className="sr-only peer"
                  />
                  <div className="relative w-11 h-6 bg-gray-200 peer-focus:outline-none rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-[#FF204E]"></div>
            ...
            <div className="w-full h-auto flex justify-between items-start">
              ...
              <div>
                <label className="inline-flex items-center cursor-pointer">
                  <input
                    checked={settings.subscriptionAdded}
                    type="checkbox"
                    disabled={dataLoading}
                    onChange={(e) =>
                      handleCheckboxChange(e, "subscriptionAdded")
                    }
                    className="sr-only peer"
                  />
                  <div className="relative w-11 h-6 bg-gray-200 peer-focus:outline-none rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-[#FF204E]"></div>
            ...
            <div className="w-full h-auto flex justify-between items-start">
              <div className="w-[90%] h-auto flex flex-col gap-1 justify-start items-start">
                <h1 className="font-bold text-black text-md ">
                  Subscription Cancellattion
                </h1>
              </div>
              <div>
                <label className="inline-flex items-center cursor-pointer">
                  <input
                    checked={settings.subscriptionCancellation}
                    type="checkbox"
                    disabled={dataLoading}
                    onChange={(e) =>
                      handleCheckboxChange(e, "subscriptionCancellation")
                    }
                    className="sr-only peer"
                  />
                  <div className="relative w-11 h-6 bg-gray-200 peer-focus:outline-none rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-[#FF204E]"></div>
